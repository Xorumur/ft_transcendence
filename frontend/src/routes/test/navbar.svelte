...
>
	<div class="container flex flex-wrap items-center justify-between mx-auto">
		<a href="/test" class="flex items-center">
			<img
				src="./assets/pong-icon.svg"
				class="h-6 mr-10 sm:h-9"
				alt="Pong logo"
			/>
			<span
				class="self-center text-xl text-blue-700 font-semibold whitespace-nowrap dark:text-white"
				>Transcendence</span
			>
		</a>
